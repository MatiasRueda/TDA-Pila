...
bool redimensionar_arriba(pila_t *pila);
void redimensionar_abajo(pila_t *pila);
...
bool redimensionar_arriba(pila_t *pila) {
    return !(pila->cantidad >= pila->capacidad && !redimensionar(pila, pila->capacidad * CAP_REDIMENSION));
}
